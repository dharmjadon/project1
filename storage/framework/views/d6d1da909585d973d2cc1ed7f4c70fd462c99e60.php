...
<?php $__env->startSection('canonical_url', config('app.url') . '/venues'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="venue-landingp module-landingp">

        <div class="categories-module">
            <ul>
                <li class="more-categories-module">
                    <a href="<?php echo e(route('venue-list', ['all'])); ?>" title="View All Venues">View All</a>
                </li>
                <?php if($categoryForSidebar): ?>
                    <?php $__currentLoopData = $categoryForSidebar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catKey => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li <?php if($catKey > 7): ?> class="d-none more-category" <?php endif; ?>>
                            ...
                            <a
                                href="<?php echo e($category->venue_count ? route('venue-list', ['category_slug' => $category->slug]) : '#'); ?>">

                                <img class="lazyload img-fluid" data-src="<?php echo e($category->storedImage($category->icon)); ?>"
                                     width="75" alt="venue - <?php echo e($category->name); ?>"></a>

                            <h3><a
                                    href="<?php echo e($category->venue_count ? route('venue-list', ['category_slug' => $category->slug]) : '#'); ?>"><?php echo e($category->name); ?></a>
                            </h3>

                            <p><?php echo e($category->venue_count ?? ''); ?></p>
                        </li>
                        ...
                        <div class="searchbar-module">
                            <form method="">
                                <div class="wraper-searchbar-module">
                                    ...
                                    <div class="field-searchbar-module">
                                        <select name="cusine_name" id="cusine_name">
                                            <option value="all" selected>Cuisine</option>
                                            <?php if($cuisins): ?>
                                                <?php $__currentLoopData = $cuisins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cusine_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($cusine_name); ?>">
                                                        <?php echo e(\Illuminate\Support\Str::limit($cusine_name, 20)); ?>
                ...
                <div class="swiper-wrapper">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <a href="<?php echo e(route('venue-list', ['category_slug' => $category->slug])); ?>"><i
                                    class="party-icon icon-search"></i>
                                <?php echo e(\Illuminate\Support\Str::limit($category->name, 15)); ?>

                                (<?php echo e($category->venue_count); ?>)
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                    ...
                    <div class="module-btn">
                        <div class="swiper module-btn-slick">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide"><a href="<?php echo e(route('book_table')); ?>"
                                                             class="gray-module-btn"><img
                                            src="/v2/images/icons/book-table.svg"
                                            alt="Book a Table"> Book a Table</a>
                                </div>
                                <div class="swiper-slide"><a
                                        href="<?php echo e(route('user-signup', ['user_type' => 'business'])); ?>"
                                        class="pink-module-btn"><img src="/v2/images/icons/become-partner.svg"
                                                                     alt="Become a Partner"> Become a Partner</a></div>
                                <div class="swiper-slide"><a
                                        href="<?php echo e(route('user-signup', ['user_type' => 'profile'])); ?>"
                                        class="blue-module-btn"><img src="/v2/images/icons/register-event.png"
                                                                     alt="Register With Us"> Register With Us!</a></div>
                            </div>
                        </div>
                        
                        <?php echo $__env->make('user.common.pop_modal', ['popup_title' => 'Venue'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="topcategory-module">
                        <div class="heading-module">
                            ...
                            <ul class="btn-heading pz-btn-heading">
                                <li><a href="<?php echo e(route('publisher.venue.create')); ?>" class="btn btn-primary">Add
                                        Listing</a>
                                    <a href="<?php echo e(route('venue-list', ['all'])); ?>" class="btn btn-secondary">View All</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="feature-module">
                            <div class="heading-module">
                                ...
                                <ul class="btn-heading">
                                    <li><a href="#featured_venue" class="btn btn-outline-primary">Feature</a>
                                        <a href="#popular_venue" class="btn btn-secondary">Popular</a>
                                    </li>
                                    <li><a href="<?php echo e(route('publisher.venue.create')); ?>" class="btn btn-primary">Add
                                            Listing</a>
                                        <a href="<?php echo e(route('venue-list', ['all'])); ?>" class="btn btn-secondary">View
                                            All</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="swiper-slick">
                                <div class="swiper feature-module-slick">
                                    <div class="swiper-wrapper">
                                        <?php if($all_venues): ?>
                                            <?php $__currentLoopData = $all_venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="swiper-slide">
                                                    <div class="itembox ib-venue">
                                                        <div class="imgeffect"><a
                                                                href="<?php echo e(route('venue-detail', $row->slug)); ?>"><img
                                                                    class="lazyload"
                                                            ...
                                                            <div class="ib-wishlist"><a href="#"
                                                                                        data-id="<?php echo e($row->id); ?>"
                                                                                        data-major-category="1"
                                                        ...
                                                        <div class="itembox-info">
                                                            ...
                                                            <p class="ib-search-btn">
                                                                <?php if($row->subCategory): ?>
                                                                    <a
                                                                        href="<?php echo e(route('venues')); ?>?sub_category_id=<?php echo e($row->subCategory->id); ?>"><i
                                                                            class="party-icon icon-search"></i><?php echo e(\Illuminate\Support\Str::limit($row->subCategory->name, 15)); ?>

                                                                        (<?php echo e($row->subCategory->venue->count()); ?>)
                                                                    </a>
                                                                <?php endif; ?>
                                                            </p>
                                                            <ul>
                                                                <li><i class="party-icon icon-cuisine"></i>
                                                                    <?php echo e($row->cusine_name); ?></li>
                                                        ...
                                                        <div class="hover-itembox">
                                                            ...
                                                            <div class="btn-itembox"><a
                                                                    href="<?php echo e(route('venue-detail', $row->slug)); ?>"
                                                                    class="btn btn-primary">View More</a>
                                                                <a href="#enquiry-modal" data-bs-toggle="modal"
                                                                   data-id="<?php echo e($row->id); ?>" data-major-cat="1"
                        ...
                        <?php if($feature_venues): ?>
                            <div class="feature-module" id="feature_venue">
                                <div class="heading-module">
                                    <h2>Find Featured Venues</h2>
                                    <ul class="btn-heading">
                                        <li><a href="#" class="btn btn-outline-primary">Feature</a> <a href="#"
                                ...
                                <div class="swiper-slick">
                                    <div class="swiper feature-module-slick">
                                        <div class="swiper-wrapper">
                                            <?php $__currentLoopData = $feature_venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="swiper-slide">
                                                    <div class="itembox ib-venue">
                                                        <div class="imgeffect"><a
                                                                href="<?php echo e(route('venue-detail', $row->slug)); ?>">
                        ...
                        <div class="briefbox-module">
                            <div class="row">
                                ...
                                <div class="col-sm-6"><img
                                        src="<?php echo e($major_category->register_image ? otherImage($major_category->register_image) : '/v2/images/job/job-seeker.jpg'); ?>"
                                        alt="<?php echo e($major_category->register_heading); ?>"></div>
                            </div>
                        </div>

                        <?php if($popular_venues): ?>
                            <div class="popular-module" id="popular_venue">
                                <div class="heading-module">
                                    <h2>Find Popular Venues</h2>
                                    <ul class="btn-heading">
                                        <li><a href="#" class="btn btn-outline-primary">Feature</a> <a href="#"
                                                                                                       class="btn btn-secondary">Popular</a>
                                        </li>
                                ...
                                <div class="swiper-slick">
                                    <div class="swiper feature-module-slick">
                                        <div class="swiper-wrapper">
                                            <?php $__currentLoopData = $popular_venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="swiper-slide">
                                                    <div class="itembox ib-venue">
                                                        <div class="imgeffect"><a
                                                                href="<?php echo e(route('venue-detail', $row->slug)); ?>"><img
                        ...
                        <?php echo $__env->make('user.common.top-popular-search-tabs', ['route_name' => 'venue-list', 'top_search_tab' => 'Top Search Venues in UAE', 'popular_search_tab' => 'Popular Venues Search in UAE'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
...
<?php echo $__env->make('user.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/user/venue/index.blade.php ENDPATH**/ ?>