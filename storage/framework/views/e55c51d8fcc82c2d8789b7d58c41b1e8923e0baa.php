...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <!-- events add start -->
        <?php echo Form::open(['url' => route('admin.manufacturer.store'), 'id' => 'form_create_buysell', 'files' => true]); ?>
            ...
            <div class="card card-outline card-pink">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="status">Manufacturer Logo <b>(optional)</b></label>
                                <input type="file" class="form-control" placeholder="Directory Logo" id="logoInput" />
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('admin.common-scripts', ['section' => 'admin', 'module_name' => 'Manufacturer', 'amenties' => [], 'landmarks' => []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#slug').slugify('#title');
            const buysellValidator = $("#form_create_buysell").validate({
                rules: {
                    title: "required",
                    slug: "required"
                },
             ...
             summernoteDescription.summernote({
                ...
                callbacks: {
                    onChange: function (contents, $editable) {
                        ...
                        buysellValidator.element(summernoteDescription);
                    },
                }
            });
          
            $('#slug, select.select2').on('change', function () {
                $(this).valid();
            });
        });
    </script>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/manufacturer/create.blade.php ENDPATH**/ ?>