...
<?php $__env->startSection('content'); ?>
    <div class="row pt-3 match-height">
        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="callout callout-success">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-02.svg')); ?>" height="20"> Venues</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="callout callout-info">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-03.svg')); ?>" height="20"> Events</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="callout callout-info">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-03.svg')); ?>" height="20"> Education</h5>
                <p class="font-small-3 mb-0">Active Events - <?php echo e($total_education); ?></p>
                <p class="font-small-3 mb-0">Waiting - <?php echo e($waiting_education); ?></p>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="callout callout-primary">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-17.svg')); ?>" height="20"> Buy & Sell</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
            <div class="callout callout-warning">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-04.svg')); ?>" height="20"> Concierges</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-primary">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-05.svg')); ?>" height="20"> Directories</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-warning">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-06.svg')); ?>" height="20"> Influencers</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-danger">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-08.svg')); ?>" height="20"> Jobs</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-primary">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-19.svg')); ?>" height="20"> Property</h5>
                <p class="font-small-3 mb-0">Active Property - <?php echo e($total_spaces); ?></p>
                <p class="font-small-3 mb-0">Waiting - <?php echo e($waiting_spaces); ?></p>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-success">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-18.svg')); ?>" height="20"> Tickets</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-danger">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-25.svg')); ?>" height="20"> Motors</h5>
                <p class="font-small-3 mb-0">Active Motors - <?php echo e($total_motors); ?></p>
                <p class="font-small-3 mb-0">Waiting - <?php echo e($waiting_motors); ?></p>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-info">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-25.svg')); ?>" height="20"> Attractions</h5>
        ...
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-info">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-25.svg')); ?>" height="20"> Crypto</h5>
                <p class="font-small-3 mb-0">Active Crypto - <?php echo e($total_crypto); ?></p>
                <p class="font-small-3 mb-0">Waiting - <?php echo e($total_crypto); ?></p>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-info">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-25.svg')); ?>" height="20">Talent</h5>
                <p class="font-small-3 mb-0">Active Talent - <?php echo e($total_talent); ?></p>
                <p class="font-small-3 mb-0">Waiting - <?php echo e($total_talent); ?></p>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 col-12 mt-2">
            <div class="callout callout-danger">
                <h5 class="text-pink"><img src="<?php echo e(asset('assets/icon/Admin-Panel-09.svg')); ?>" height="20"> Meetup</h5>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="venue-tab" data-toggle="tab" href="#venue"
                               aria-controls="venue" role="tab" aria-selected="true">Venues (<?php echo e(count($venues)); ?>)</a>
                        </li>
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" id="event-tab" data-toggle="tab" href="#event" aria-controls="event"
                               role="tab" aria-selected="false">Education (<?php echo e(count($education)); ?>)</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="buy_sell-tab" data-toggle="tab" href="#buy_sell"
                               aria-controls="buy_sell" role="tab" aria-selected="false">Buy & Sell (<?php echo e(count($buysell)); ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="job-tab" data-toggle="tab" href="#job" aria-controls="job"
                               role="tab" aria-selected="false">Property (<?php echo e(count($accommodation)); ?>)</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="motors-tab" data-toggle="tab" href="#motors"
                               aria-controls="attraction" role="tab" aria-selected="false">Motors (<?php echo e(count($motors)); ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="motors-tab" data-toggle="tab" href="#motors"
                               aria-controls="attraction" role="tab" aria-selected="false">Crypto (<?php echo e(count($crypto)); ?>

                                )</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" id="talent-tab" data-toggle="tab" href="#talent"
                               aria-controls="talent" role="tab" aria-selected="false">Talent (<?php echo e(count($talent)); ?>
                    ...
                    <div class="tab-content">
                            ...
                            <table class="table" id="datatable7">
                                ...
                                <?php $__currentLoopData = $accommodation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($data->title); ?></td>
                                        <td><?php echo e(($data->accommodation_type==4)?'Buy':'Rent'); ?></td>
                                        <td><?php echo e($data->views); ?></td>
                                        <td><?php echo e($data->enquiries_count); ?></td>
                                        <td><?php echo e($data->click_count_email_count); ?></td>
                                        <td><?php echo e($data->click_count_phone_count); ?></td>
                        ...
                        <div class="tab-pane" id="motors" aria-labelledby="motors-tab" role="tabpanel">
                            <table class="table responsive" id="datatable_motors">
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                <?php $sl_no9 = 1; ?>
                                <?php $__currentLoopData = $motors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($sl_no9); ?></td>
                                        <td><?php echo e($data->title); ?></td>
                                        <td><?php echo e(($data->accommodation_type==1)?'Buy':'Rent'); ?></td>
                                        <td><?php echo e($data->views); ?></td>
                                        <td><?php echo e($data->enquiries_count); ?></td>
                                        <td><?php echo e($data->click_count_email_count); ?></td>
                                        <td><?php echo e($data->click_count_phone_count); ?></td>
                        ...
                        <div class="tab-pane" id="talent" aria-labelledby="talent-tab" role="tabpanel">
                            <table class="table responsive">
                                ...
                                <tbody>
                                <?php $sl_no9 = 1; ?>
                                <?php $__currentLoopData = $talent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($sl_no9); ?></td>
                                        <td><?php echo e($data->title); ?></td>
                                        <td><?php echo e($data->views); ?></td>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table_motor = $('#datatable_motors').DataTable({
                responsive: true,
                dom:
                    '<"card-header border-bottom p-1"<"head-label"><"dt-action-buttons text-right"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
                buttons: [
...
*/
    ...
    <script>
        $(".month-filter, .week-filter").on('change', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.month-filter')); ?>",
                method: 'POST',
                data: {monthId: id, weekId: weekId, _token: "<?php echo e(csrf_token()); ?>"},
                success: function (response) {
                    ...
                    $("canvas").remove();
                    document.querySelector("#chartReport").innerHTML = '<canvas id="bar-chart" width="600" height="200"></canvas>';
                    new Chart(document.getElementById("bar-chart"), {
                        type: 'bar',
                        data: {
                            labels: ["Venues", "Events", "Education", "Buy & Sell", "Directories", "Concierge", "Influencers", "Property", "Attractions", "Motors", "Crypto","Talent"],
                            datasets: [
                                {
                                    label: "Enquiry Form",
                                    backgroundColor: "#000",
                                    data: [data.venue, data.event, data.education, data.buysell, data.directory, data.concierge, data.influencer, data.accommodation, data.attraction, data.motors, data.crypto, data.talent]
                                },
                                {
                                    label: "Whatsapp",
                                    backgroundColor: "#682e82",
                                    data: [whatsapp.venue, whatsapp.event, whatsapp.education, whatsapp.buysell, whatsapp.directory, whatsapp.concierge, whatsapp.influencer, whatsapp.accommodation, whatsapp.attraction, whatsapp.motors, whatsapp.crypto, whatsapp.talent]
                                },
                                {
                                    label: "Whatsapp",
                                    backgroundColor: "#bf077f",
                                    data: [email.venue, email.event, email.education, email.buysell, email.directory, email.concierge, email.influencer, email.accommodation, email.attraction, email.motors, email.crypto, email.talent]
                                },
                                {
                                    label: "Whatsapp",
                                    backgroundColor: "#ec5983",
                                    data: [phone.venue, phone.event, phone.education, phone.buysell, phone.directory, phone.concierge, phone.influencer, phone.accommodation, phone.attraction, phone.motors, phone.crypto, phone.talent]
                                },
    ...
    <script>
        new Chart(document.getElementById("bar-chart"), {
            type: 'bar',
            data: {
                labels: ["Venues", "Events", "Buy & Sell", "Directories", "Concierge", "Influencers", "Property", "Attractions", "Motors","Education","Crypto","Talent"],
                datasets: [
                    {
                        label: "Enquiry Form",
                        backgroundColor: "#000",
                        data: [<?php echo e($enquiry['venue']); ?>, <?php echo e($enquiry['event']); ?>, <?php echo e($enquiry['buysell']); ?>, <?php echo e($enquiry['directory']); ?>, <?php echo e($enquiry['concierge']); ?>,
                            <?php echo e($enquiry['influencer']); ?>, <?php echo e($enquiry['accommodation']); ?>, <?php echo e($enquiry['attraction']); ?>, <?php echo e($enquiry['motors']); ?>, <?php echo e($enquiry['education']); ?>, <?php echo e($enquiry['crypto']); ?>, , <?php echo e($enquiry['talent']); ?>]
                    },
                    {
                        label: "Whatsapp",
                        backgroundColor: "#682e82",
                        data: [<?php echo e($whatsapp['venue']); ?>, <?php echo e($whatsapp['event']); ?>, <?php echo e($whatsapp['buysell']); ?>, <?php echo e($whatsapp['directory']); ?>, <?php echo e($whatsapp['concierge']); ?>,
                            <?php echo e($whatsapp['influencer']); ?>, <?php echo e($whatsapp['accommodation']); ?>, <?php echo e($whatsapp['attraction']); ?>, <?php echo e($whatsapp['motors']); ?>, <?php echo e($whatsapp['education']); ?>, <?php echo e($whatsapp['crypto']); ?>, , <?php echo e($whatsapp['talent']); ?>]
                    },
                    {
                        label: "Email",
                        backgroundColor: "#bf077f",
                        data: [<?php echo e($email['venue']); ?>, <?php echo e($email['event']); ?>, <?php echo e($email['buysell']); ?>, <?php echo e($email['directory']); ?>, <?php echo e($email['concierge']); ?>,
                            <?php echo e($email['influencer']); ?>, <?php echo e($email['accommodation']); ?>, 
                            <?php echo e($email['attraction']); ?>, <?php echo e($email['motors']); ?>, <?php echo e($email['education']); ?>, <?php echo e($email['crypto']); ?>, , <?php echo e($email['talent']); ?>]
                    },
                    {
                        label: "Phone",
                        backgroundColor: "#ec5983",
                        data: [<?php echo e($phone['venue']); ?>, <?php echo e($phone['event']); ?>, <?php echo e($phone['buysell']); ?>, <?php echo e($phone['directory']); ?>, <?php echo e($phone['concierge']); ?>,
                            <?php echo e($phone['influencer']); ?>, <?php echo e($phone['accommodation']); ?>, 
                            <?php echo e($phone['attraction']); ?>, <?php echo e($phone['motors']); ?>, <?php echo e($phone['education']); ?>, <?php echo e($phone['crypto']); ?>, , <?php echo e($phone['talent']); ?>]
                    },
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/home/index.blade.php ENDPATH**/ ?>