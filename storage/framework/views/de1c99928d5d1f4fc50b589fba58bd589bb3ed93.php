...
<?php $__env->startSection('content'); ?>
    <div class="card card-outline card-pink">
        <div class="card-header">
            <h4 class="card-title">All Wishlist</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="gallery-tab" data-toggle="tab" href="#gallery" aria-controls="gallery"
                           role="tab" aria-selected="false">Gallery
                            (<?php echo e(count($datas->where('item_type','App\Models\Gallery'))); ?>)</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="news-tab" data-toggle="tab" href="#news" aria-controls="news" role="tab"
                           aria-selected="false">News (<?php echo e(count($datas->where('item_type','App\Models\News'))); ?>)</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="recommendation-tab" data-toggle="tab" href="#recommendation"
                           aria-controls="recommendation" role="tab" aria-selected="false">Recommendation
                            (<?php echo e(count($datas->where('item_type','App\Models\ItemRecommendation'))); ?>)</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="motors-tab" data-toggle="tab" href="#motors" aria-controls="motors"
                           role="tab" aria-selected="false">Motor
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="attraction-tab" data-toggle="tab" href="#attraction" aria-controls="attraction"
                ...
                <div class="tab-content">
                        ...
                        <table class="table" id="datatable1">
                            ...
                            <?php $__currentLoopData = $datas1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($data->user ? $data->user->name : ''); ?></td>
                                    <td>


                                        <?php if(isset($data->item)): ?>
                                            <a type="button" target="_blank"
                                               href="<?php echo e(route('venue-detail',$data->item->slug)); ?>"
                    ...
                    <div class="tab-pane" id="news" aria-labelledby="news-tab" role="tabpanel">
                    ...
                    <div class="tab-pane" id="recommendation" aria-labelledby="recommendation-tab" role="tabpanel">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(route('client.delete_wishlist')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function ajax_render_table(table_nam, module_name) {
            ...
            $('#prepage').show();
            $.ajax({
                url: "<?php echo e(route('admin.wishlist-ajax-tab')); ?>",
                method: 'GET',
    ...
    <script>
        $(document).ready(function () {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
                ...
                if (split_ab == "venue-tab") {
                ...
                } else if (split_ab == "gallery-tab") {

                    ajax_render_table("datatable8", "gallery");
                } else if (split_ab == "news-tab") {

                    ajax_render_table("datatable9", "news");
                } else if (split_ab == "recommendation-tab") {

                    ajax_render_table("datatable10", "recommend");
                    ...
                    ajax_render_table("datatable10", "attraction");
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/wishlist/wishlist.blade.php ENDPATH**/ ?>