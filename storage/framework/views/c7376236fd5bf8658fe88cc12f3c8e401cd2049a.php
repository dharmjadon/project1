    ...
    <div class="content-body">
        ...
        <section class="app-user-edit">
            <div class="card card-outline card-pink">
                <div class="card-body">
                    <a class="btn btn-primary mb-2" href="<?php echo e(route('admin.brand.create')); ?>">Add Brand <i data-feather="plus"></i></a>
                    <div class="row">
                        <div class="col-md-12">
            ...
            var table = $('.data-table').DataTable({
                ...
                $('[data-toggle="switch"]').bootstrapSwitch({
                    ...
                    onSwitchChange: function (event, state) {
                        ...
                        $('#prepage').show();
                         $.ajax({
                            url: "<?php echo e(route('admin.brand.update-status')); ?>",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                id: id,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/brand/index.blade.php ENDPATH**/ ?>