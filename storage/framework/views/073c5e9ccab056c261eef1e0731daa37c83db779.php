...
<?php $__env->startSection('content'); ?>
    <div class="card card-outline card-pink">
        <div class="card-body">
            <a class="btn btn-primary mb-2" href="<?php echo e(route('admin.sub-category.create')); ?>">Add Sub Category <i
                    data-feather="plus"></i></a>

            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="venue-tab" data-toggle="tab" href="#venue" aria-controls="venue"
                       role="tab" aria-selected="true">Venue
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',1)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="event-tab" data-toggle="tab" href="#event" aria-controls="event" role="tab"
                       aria-selected="false">Event (<?php echo e($datas->where('mainCategory.major_category_id','=',2)->count()); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="buy_sell-tab" data-toggle="tab" href="#buy_sell" aria-controls="buy_sell"
                       role="tab" aria-selected="false">Buy & Sell
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',3)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="directory-tab" data-toggle="tab" href="#directory" aria-controls="directory"
                       role="tab" aria-selected="false">Directory
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',4)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="concierge-tab" data-toggle="tab" href="#concierge" aria-controls="concierge"
                       role="tab" aria-selected="false">Concierge
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',5)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="influencer-tab" data-toggle="tab" href="#influencer"
                       aria-controls="influencer" role="tab" aria-selected="false">Influencer
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',6)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="job-tab" data-toggle="tab" href="#job" aria-controls="job" role="tab"
                       aria-selected="false">Job (<?php echo e($datas->where('mainCategory.major_category_id','=',7)->count()); ?>

                        )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="ticket-tab" data-toggle="tab" href="#ticket" aria-controls="ticket"
                       role="tab" aria-selected="false">Ticket
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',8)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="spaces-tab" data-toggle="tab" href="#spaces" aria-controls="spaces"
                       role="tab" aria-selected="false">Property
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',9)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="attractions-tab" data-toggle="tab" href="#attractions"
                       aria-controls="attractions" role="tab" aria-selected="false">Attractions
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',10)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="book-artist-tab" data-toggle="tab" href="#book_artist"
                       aria-controls="book_table" role="tab" aria-selected="false">Book an Artist
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',11)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="give-away-tab" data-toggle="tab" href="#give_away"
                       aria-controls="book_table" role="tab" aria-selected="false">Give Away
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',12)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="motors-tab" data-toggle="tab" href="#motors" aria-controls="book_table"
                       role="tab" aria-selected="false">Motors
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',config('global.motor_major_id'))->count()); ?>

                        )</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="education-tab" data-toggle="tab" href="#education" aria-controls="education"
                       role="tab" aria-selected="false">Education
                        (<?php echo e($datas->where('mainCategory.major_category_id','=',14)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="its-tab" data-toggle="tab" href="#its" aria-controls="book_table"
                       role="tab" aria-selected="false">ITs
                        (<?php echo e($datas->where('mainCategory.major_category_id', '=', 15)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="crypto-tab" data-toggle="tab" href="#crypto" aria-controls="book_table"
                       role="tab" aria-selected="false">Crypto
                        (<?php echo e($datas->where('mainCategory.major_category_id', '=', 16)->count()); ?>)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="talent-tab" data-toggle="tab" href="#talent" aria-controls="book_table"
                       role="tab" aria-selected="false">Talent
                        (<?php echo e($datas->where('mainCategory.major_category_id', '=', 17)->count()); ?>)</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="venue" aria-labelledby="venue-tab" role="tabpanel">
                    <table class="table" id="datatable">
                        ...
                        <tbody>
                        <?php $sl_no = 1; ?>
                        <?php $__currentLoopData = $datas->where('mainCategory.major_category_id', '=', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success"
                                       href="<?php echo e(route('admin.sub-category.edit', $data->id)); ?>">
                ...
                <div class="tab-pane" id="book_artist" aria-labelledby="book-artist-tab" role="tabpanel">
                ...
                <div class="tab-pane" id="give_away" aria-labelledby="attractions-tab" role="tabpanel">
                ...
                <div class="tab-pane" id="its" aria-labelledby="its-tab" role="tabpanel">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="post" action="<?php echo e(route('admin.sub-category.delete')); ?>">
                            <?php echo csrf_field(); ?>
        ...
        <?php $__env->startSection('script'); ?>
            ...
            <script>
                function ajax_render_table(table_nam, module_name) {
                    ...
                    $('#prepage').show();
                    $.ajax({
                        url: "<?php echo e(route('admin.sub-category-ajax')); ?>",
                        method: 'GET',
                        data: {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/sub-category/index.blade.php ENDPATH**/ ?>