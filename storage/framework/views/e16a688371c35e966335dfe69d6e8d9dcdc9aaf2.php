                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="venue-tab" data-toggle="tab" href="#venue" aria-controls="venue"
                           role="tab" aria-selected="true">Venues
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Venue'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="event-tab" data-toggle="tab" href="#event" aria-controls="event"
                           role="tab" aria-selected="false">Events
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Events'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="buy_sell-tab" data-toggle="tab" href="#buy_sell"
                           ...
                           role="tab" aria-selected="false">Buy & Sell
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\BuySell'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="directory-tab" data-toggle="tab" href="#directory"
                           ...
                           role="tab" aria-selected="false">Directories
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Directory'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="concierge-tab" data-toggle="tab" href="#concierge"
                           ...
                           role="tab" aria-selected="false">Concierges
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Concierge'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="influencer-tab" data-toggle="tab" href="#influencer"
                           aria-controls="influencer" role="tab" aria-selected="false">Influencers
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Influencer'))); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="accommodation-tab" data-toggle="tab" href="#accommodation"
                           aria-controls="job"
                           role="tab" aria-selected="false">Property
                            (<?php echo e(count($datas->where('reviewable_type', 'App\Models\Accommodation'))); ?>)</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="venue" aria-labelledby="venue-tab" role="tabpanel">
                        ...
                        <table class="table" id="datatable1">
                            ...
                            <?php $sl_no = 1; ?>
                            <?php
                                $datas1 = $datas->where('reviewable_type', 'App\Models\Venue');
                            ?>
                            <?php $__currentLoopData = $datas1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($sl_no); ?></td>
                                        <?php $item = substr($data->reviewable_type, 10); ?>
                                    <td><?php echo e($item); ?></td>
                                    <?php if($item == 'BuySell'): ?>
                                        <td><?php echo e($data->reviewable ? $data->reviewable->product_name : ''); ?></td>
                                    <?php else: ?>
                                        <td><?php echo e($data->reviewable ? $data->reviewable->title : ''); ?></td>
                                    <?php endif; ?>
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="change_status" id="<?php echo e($data->id); ?>"
                                                   <?php if($data->approved == 0): ?> unchecked <?php else: ?> checked <?php endif; ?>>
                    ...
                    <div class="tab-pane" id="accommodation" aria-labelledby="accommodation-tab" role="tabpanel">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(route('admin.review.delete')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function ajax_render_table(table_nam, module_name) {
            ...
            $('#prepage').show();
            $.ajax({
                url: "<?php echo e(route('admin.reviews-ajax-tabs-table')); ?>",
                method: 'GET',
    ...
    <script>
        $(document).ready(function () {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
                ...
                } else if (split_ab == "accommodation-tab") {

                    ajax_render_table("datatable7", "accommodation");
                } else if (split_ab == "attraction-tab") {

                    ajax_render_table("datatable8", "attraction");
                } else if (split_ab == "motors-tab") {

                    ajax_render_table("datatable9", "motors");
    ...
    <script>
        $(document).on("change", ".change_status", function () {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.approve-review')); ?>",
                method: 'POST',
                data: {
                    id: id,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/review/index.blade.php ENDPATH**/ ?>