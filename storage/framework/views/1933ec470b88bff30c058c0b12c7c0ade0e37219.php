...
<div class="card card-outline card-pink">
    <div class="card-body">
        <div class="table-responsive">
            <a class="btn btn-primary mb-2" href="<?php echo e(route('admin.landmark.create')); ?>">Add Landmark <i data-feather="plus"></i></a>
            <table class="table" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a  href="<?php echo e(route('admin.landmark.edit', $data->id)); ?>" type="button" class="btn btn-sm btn-success">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post" action="<?php echo e(route('admin.landmark.delete')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/landmark/index.blade.php ENDPATH**/ ?>