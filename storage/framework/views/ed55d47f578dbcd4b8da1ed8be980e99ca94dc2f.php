            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/publisher/motors">Motors List</a></li>
...
<?php $__env->startSection('content'); ?>
    <div class="content-body">
        <!-- events add start -->
        <?php echo Form::model($motor, ['id' => 'form_edit_motor', 'method' => 'PATCH', 'url' => route('publisher.motors.update', $motor->id), 'files' => true]); ?>
        ...
        <section class="app-user-edit">
             ...
             <div class="card card-outline card-pink">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 accommodation_class <?php if($motor->accommodation_type==1): ?> display='none' <?php endif; ?>">
                            <div class="form-group">
            ...
            <div class="col-12">
                ...
                <button type="button" id="more-info-modal-button mt-2" class="btn btn-outline-primary ms-5"
...
<?php echo $__env->make('publisher.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/publisher/motors/edit.blade.php ENDPATH**/ ?>