...
<?php $__env->startSection('content'); ?>
    <div class="content-body">
        <!-- directoriess add start -->
        <section class="app-user-edit">
            <div class="card card-outline card-pink">
                <div class="card-body">

                    <a class="btn btn-primary mb-2 float-end" href="<?php echo e(route('admin.directories.create')); ?>">Add Directory
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col">
                                        <select class="form-control selectpicker" name="main_category" id="main_category"
                                            ...
                                            title="All Cateogries" data-selected-text-format="count"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(route('admin.directories.delete')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'founded_date', name: 'founded_date',
                ...
                order: [[<?php echo e(auth()->user()->user_type == 1 ? 7 : 6); ?>, 'desc']],
                deferRender: true
            }).on('draw', function() {
                feather.replace();
                $('[data-toggle="switch"]').bootstrapSwitch({
                    ...
                    onSwitchChange: function (event, state) {
                        ...
                        else if($(this).hasClass('directory-status')) {
                            field = 'status';
                        } else {
                            field = '';
                        }
                        ...
                        $('#prepage').show();
                        $.ajax({
                            url: "<?php echo e(route('admin.update_status_directories')); ?>",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                id: id,
                            ...
                            error: function (res) {
                                $('#prepage').hide();
                                toastr.error('There was a problem while updating directory. Please try later.');
                            },
                            fail: function (res) {
                                $('#prepage').hide();
                                toastr.error('There was a problem while updating directory. Please try later.');
            ...
            window._directories_table = table;

            $('#search').on('keyup', function() {
                table.draw();
            });
            $('#directory_status, #main_category, #is_featured').on('change', function() {
                table.draw();
            });

            $('#clearBtn').on('click', function() {
                $('#directory_status').val('All');
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/directories/index.blade.php ENDPATH**/ ?>