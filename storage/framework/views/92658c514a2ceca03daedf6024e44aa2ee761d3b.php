        ...
        <section class="app-user-edit">
            <div class="card card-outline card-pink">
                <div class="card-body">
                    ...
                    <a class="btn btn-primary mb-2" href="<?php echo e(route('admin.venue.create')); ?>">Add Venue <i
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                $('[data-toggle="switch"]').bootstrapSwitch({
                    ...
                    onSwitchChange: function (event, state) {
                        ...
                        else if($(this).hasClass('venue-status')) {
                            field = 'status';
                        } else {
                            field = '';
                        }
                        ...
                        $('#prepage').show();
                        $.ajax({
                            url: "<?php echo e(route('admin.update_status_venue')); ?>",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                id: id,
            ...
            window._venues_table = table;

            $('#search').on('keyup', function () {
                table.draw();
            });
            $('#venue_status, #main_category, #is_featured').on('change', function () {
                table.draw();
            });

            $('#clearBtn').on('click', function () {
                $('#venue_status').val('All');
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/venue/index.blade.php ENDPATH**/ ?>