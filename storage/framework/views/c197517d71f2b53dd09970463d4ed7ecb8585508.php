        ...
        <section class="app-user-edit">
            <div class="card card-outline card-pink">
                <div class="card-body">
                    ...
                    <a class="btn btn-primary mb-2" href="<?php echo e(route('admin.motors.create')); ?>">Add Motor <i
        ...
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                $('[data-toggle="switch"]').bootstrapSwitch({
                    size: 'small',
                    onText: $(this).hasClass('motor-status') ? 'ON' : 'YES',
                    offText: $(this).hasClass('motor-status') ? 'OFF' : 'NO',
                    onColor: 'green',
                    offColor: 'default',
                    onSwitchChange: function (event, state) {
                        ...
                        else if($(this).hasClass('motor-status')) {
                            field = 'status';
                        } else {
                            field = '';
                        }
                        ...
                        $('#prepage').show();
                        $.ajax({
                            url: "<?php echo e(route('admin.update_status_motor')); ?>",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                id: id,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/motors/index.blade.php ENDPATH**/ ?>