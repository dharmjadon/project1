            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/motor">Motor List</a></li>
...
<?php $__env->startSection('content'); ?>
    <div class="content-body">
        <!-- events add start -->
        <?php echo Form::open(['url' => route('admin.motors.store'), 'id' => 'form_create_motor', 'files' => true]); ?>
        ...
        <section class="app-user-edit">
                            ...
                            <div class="event-field-wrapper">
                                <div class="row mb-3">
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" name="event[0][name]" class="form-control" id="event_name_0"
            ...
            <div class="row mb-3">
                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                    <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1" id="submit_request">Submit
                    </button>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\partyfinder\resources\views/admin/motors/create.blade.php ENDPATH**/ ?>