...
class JobCompanyController extends Controller
{
    ...
    {
        $this->middleware('role_or_permission:Admin|job-company-add', ['only' => ['create', 'store']]);
        $this->middleware('role_or_permission:Admin|job-company-view', ['only' => ['index']]);
        $this->middleware('role_or_permission:Admin|job-company-update', ['only' => ['edit', 'update', 'update_status_companies']]);
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($companies)
                ->addColumn('active', function ($company) use ($auth_user_type) {
                    if ($auth_user_type === 1) {
                        return '<input type="checkbox" class="company-status" data-toggle="switch" data-size="small"
                    data-on-color="green" data-on-text="ON" data-off-color="default" data-off-text="OFF"
                    data-id="' . $company->id . '" value="' . $company->status . '" ' . ($company->status ? "checked" : "") . '>';
                    }
                    return '';
                })
                ->addColumn('action', function ($company) {
                    $btn = '<div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="' . route('admin.job-company.edit', $company->id) . '">
        ...
        return view('admin.job-company.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('admin.job-company.create', get_defined_vars());
    }
    ...
    {
        return view('admin.job-company.show', get_defined_vars());
    }
    ...
    public function edit(JobCompany $jobCompany)
    {
        ...
        return view('admin.job-company.edit', get_defined_vars());
    }
